...
The instructions \texttt{B}, \texttt{BR} and \texttt{BV} are the instructions used for a local. The address computation, whether IA-relative or region relative, will not impact the region portion of the instruction address. 
