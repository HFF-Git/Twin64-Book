...
%--------------------------------------------------------------------------------
\unnumberedSection{Window Stacks}
...
%--------------------------------------------------------------------------------
\unnumberedSection{Processor Window}
...
\end{tikzpicture}
\caption{Simulator CPU Window}
\label{fig:simulator-cpu-window}
\end{figure}
...
%--------------------------------------------------------------------------------
\unnumberedSection{Memory Window}
...
\end{tikzpicture}
\caption{Simulator Memory Window}
\label{fig:simulator-mem-window}
\end{figure}
