...
\end{tikzpicture}
\caption{Simulator Cache Window}
\label{fig:simulator-cache-window}
\end{figure}
...
The TLB (Translation Lookaside Buffer) window displays the contents of the processor’s address translation cache. The TLB accelerates virtual-to-physical address translation by caching recently used page table entries. The simulator supports instruction TLBs, data TLBs, and optionally a unified TLB. All TLB-related information is presented in TLB windows.
