...
%--------------------------------------------------------------------------------
\pagebreak
\unnumberedSection{WT - Window toggle}
...
For example, memory windows may use toggles to switch between data formats such as 32-bit hexadecimal, 64-bit hexadecimal, decimal, or ASCII.
