...
%--------------------------------------------------------------------------------
\pagebreak
\unnumberedSection{WR - Set window radix}
...
Changing the radix affects only the display of numeric data. The underlying values remain unchanged. For some window types, certain content is always shown in a fixed radix. For example, addresses in a memory window are always displayed in hexadecimal, while the data values follow the selected radix.
\end{iPageDescEntry}
