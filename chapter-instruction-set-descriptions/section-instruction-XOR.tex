...
\begin{iPageDescEntry}{Syntax}
  \texttt{XOR[.C/N] RegR, RegB, RegA} \\
  \texttt{XOR[.C/N] RegR, RegB, val}
  
  \texttt{XOR[.C/N/D/W/H/B] RegR, ofs( RegB )} \\
  \texttt{XOR[.C/N/D/W/H/B] RegR, RegX ( RegB )}
\end{iPageDescEntry}
...
// ??? what is immediate ? sign extended ?
