...
%--------------------------------------------------------------------------------
\pagebreak
\unnumberedSection{AND - Boolean Operation}

%--------------------------------------------------------------------------------
\begin{iPageDescEntry}{Syntax}
  \texttt{AND[.C/N] RegR, RegB, RegA} \\
  \texttt{AND[.C/N] RegR, RegB, val}
  
  \texttt{AND[.C/N/D/W/H/B] RegR, ofs( RegB )} \\
  \texttt{AND[.C/N/D/W/H/B] RegR, RegX ( RegB )}
\end{iPageDescEntry}

%--------------------------------------------------------------------------------
\begin{iPageDescEntry}{Format}
  The AND instruction uses uses the following instruction formats. \\
	
  \begin{flushleft}	
  \drawInstrFormat
  	{0,1,3,5,5.5,6,6.5,8.5,9.5,11.5,16}
  	{\OpCodeGrpALU,\OpCodeAND, RegR, N, C, 0, RegB, 0, RegA, 0}
