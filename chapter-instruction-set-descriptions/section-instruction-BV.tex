...
he \texttt{BV} instruction performs an unconditional region relative branch. The target address is formed by taking the contents of \texttt{RegX}, shifting the value according to the selected scale factor, and adding the result to \texttt{RegX}.
