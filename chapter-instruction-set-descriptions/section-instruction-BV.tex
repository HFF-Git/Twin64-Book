...
The \texttt{BV} instruction performs an unconditional segment relative branch. The content of \texttt{RegX} is shifted by two and added to \texttt{RegB}, forming the target offset in the current segment. The return link is stored in \texttt{RegR}.  
