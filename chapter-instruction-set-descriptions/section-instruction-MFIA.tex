...
%--------------------------------------------------------------------------------
\pagebreak
\section*{MFIA  - Move from instruction address register}
\addcontentsline{toc}{section}{MFIA - Move from instruction address register}
...
\instructionentry{Format}{
	...
	The MFIA instruction uses the xxx  instruction format. \\
