...
where \textit{address} is any expression evaluating to a memory address and \textit{type} specifies the access size and sign-extension mode.
...
Examples (assume the value at 0x1000 is 0xaaaa\_bbbb\_cccc\_dddd:
