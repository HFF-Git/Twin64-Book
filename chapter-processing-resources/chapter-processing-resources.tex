...
\begin{tikzpicture}[scale=0.9, transform shape]
	...
	\draw[thick] (\leftofs, 15) -- (\rightofs, 15);
  	...
  	\node at ( \middleofs, {7 + 0.5}) { Interrupt Vector Adress };
  	...
  	\node at ( \middleofs, {3 + 0.5}) { Interruption Instruction };
...
\subsection*{Interruption Instruction}
\addcontentsline{toc}{subsection}{Interruption Instruction}

\subsection*{Interruption Address}
...
\begin{longtable}{@{}p{0.25\linewidth}p{0.6\linewidth}@{}}
    ...
    \midrule
    \textbf{P} & When set, the processor does protection Id checking. \\
    \midrule 
    \textbf{...} & ... \\
\end{longtable}
...
\begin{tikzpicture}[scale=0.9, transform shape]
    ...
    \node[anchor=west] at (11,2.75) {20bit};
