...
\begin{longtable}{@{}p{0.3\linewidth}p{0.3\linewidth}p{0.3\linewidth}@{}}
    ...
    \bottomrule
    \endlastfoot
    \textbf{ASR Rm, Rn, amt} & EXTR.S Rn, Rm, amt, 64 - amt & arithmetic shift right by "amt" bits of RegN. The result is stored in RegM. \\
    \midrule
    \textbf{LSR Rm, Rn, amt} & EXTR.S Rn, Rm, amt, 64 - amt & logical shift right by "amt" bits of RegN. The result is stored in RegM. \\
    \midrule
    \textbf{ASL Rm, Rn, amt} & DSR Rm, Rn, R0, amt, 64 - amt & arithmetic shift left by "amt" bits of RegN. The result is stored in RegM. \\
    \midrule
    \textbf{LSL Rm, Rn, amt} & DSR Rm, Rn, R0, amt, 64 - amt & logical shift left by "amt" bits of RegN. The result is stored in RegM. \\
    \midrule
    \textbf{ROR Rm, Rn, amt} & DSR Rm, Rn, Rn, amt & rotate RegN right my amount bits and store in RegM\\
    \midrule
    \textbf{ROL Rm, Rn, amt} & DSR Rm, Rn, Rn, 64 - amt & rotate RegN left my amount bits and store in RegM \\
    \midrule
