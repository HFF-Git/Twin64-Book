...
\begin{longtable}{@{}p{0.3\linewidth}p{0.3\linewidth}p{0.3\linewidth}@{}}
    ...
    \bottomrule
    \endlastfoot
    \textbf{LDI} Rn, val & LDO Rn, val & load an immediate value in the range of $\pm 2^{12}$ \\
	\midrule
	\textbf{LDI} Rn, val & LDIL.L Rn, L\%val \newline LDO Rn, R\%val & load an immediate value in the range of $\pm 2^{31}$ \\
	\midrule
	\textbf{LDI} Rn, val & LDIL.S Rn, S\%val \newline LDIL.L Rn, L\%val \newline LDO Rn, R\%val & load an immediate value in the range of $\pm 2^{51}$ \\
	\midrule
	\textbf{LDI} Rn, val & LDIL.U Rn, U\%val  \newline LDIL.S Rn, S\%val  \newline LDIL.L Rn, L\%val \newline LDO Rn, R\%val & load an immediate value in the range of $\pm 2^{63}$ \\
	\midrule
\end{longtable}
...
\begin{longtable}{@{}p{0.3\linewidth}p{0.3\linewidth}p{0.3\linewidth}@{}}
    ...
    \midrule
     ...
     % Combine the 6 branch instructions
    \textbf{TEQ} Rn, target & MBR.EQ Rn, Rn, target &
         \multirow{6}{*}{\parbox{1\linewidth}{test RegN and branch on condition.}} \\
    \textbf{TLT} Rn, target & MBR.LT Rn, Rm, target &  \\
    \textbf{TGT} Rn, target & MBR.GT Rn, Rm, target &  \\
    \textbf{TEV} Rn, target & MBR.EV Rn, Rm, target &  \\
    \textbf{TNE} Rn, target & MBR.NE Rn, Rm, target &  \\
    \textbf{TGE} Rn, target & MBR.GE Rn, Rm, target &  \\
    \textbf{TLE} Rn, target & MBR.LE Rn, Rm, target &  \\
    \textbf{TOD} Rn, target & MBR.OD Rn, Rm, target &  \\
    \midrule
