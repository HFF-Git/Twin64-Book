...
The \texttt{LF} command opens an ELF format file and places the ELF segments at the specified address. 

This command is currently under construction and will be finalized when the actual ELF file segments and sections are defined for Twin-64.
