...
The \texttt{RM} command removes a T64 module from the system. If there are any windows associated with the module, they will be removed as well. The ALL option removes all modules.
