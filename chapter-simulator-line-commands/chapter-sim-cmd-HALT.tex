...
The \texttt{HALT} command will stop a T64 module or the entire simulation. Modules running in a thread, such as processors and I/O modules, will enter the HALT state and wait for restarting. If the argument is "ALL", the entire system is halted.
