...
An optional message string may be provided to help identify the purpose of the assertion or the condition that failed. This is useful when debugging scripts, testing expressions, or validating program state during execution.
