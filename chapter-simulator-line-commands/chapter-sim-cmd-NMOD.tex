...
%--------------------------------------------------------------------------------
\pagebreak
\unnumberedSection{NMOD - create a new T64 module}

%--------------------------------------------------------------------------------
\begin{iPageDescEntry}{Syntax}
\texttt{NMOD <mType> , <modNum>  \{ , <key>=<val> \}* } \\
\end{iPageDescEntry}
...
The \texttt{module type} parameter defines the module to be added. There are three types, \texttt{PROC}, \texttt{TLB}, \texttt{MEM} and \texttt{IO}. The module number parameter assigns the module number. The Twin-64 system supports up to 64 modules at the system level. 
