...
The \texttt{ADD} instruction adds two signed 64-bit operands and stores them to the target register \texttt{RegR}. The instruction supports the immediate, the register and the two memory reference instruction formats. 
}
