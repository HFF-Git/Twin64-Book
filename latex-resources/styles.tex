...
% created by the separators. A bit position is 0.5cm.
%
%--------------------------------------------------------------------------------
...
%--------------------------------------------------------------------------------
% Instruction format for a 64bit word. It still has 16cm width and the same 
% display logic as the 32-bit counterpart. A bit position is 0.25cm.
%
%--------------------------------------------------------------------------------
\newcommand{\drawInstrFormatSixtyFour}[2]{%
  	\begin{tikzpicture}[scale=0.7, transform shape]
    	...
    	% Split labels into individual macros
    	\foreach [count=\i] \l in {#2} {%
      		\expandafter\xdef\csname label@\i\endcsname{\l}%
    	}
